...
def plot_subplots_of_labels(tracks, 
    ...
    tracks_to_plot = remove_tracks_by_criteria(tracks_to_plot, minimum_lifetime=minimum_lifetime, maximum_lifetime=maximum_lifetime, number_of_channels=number_of_channels)
